...
@section('title', 'New Category | PosSales')

@section('content_header')
<div class="d-flex justify-content-between align-items-center">
    <h1 style="font-size:1.3rem; font-weight:600; color:#343a40;">
        <i class="fas fa-folder mr-2" style="color:#e83e8c;"></i> New Category
    </h1>
    <div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter category name" required value="{{ old('name') }}">
                                @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" placeholder="e.g., fa-box, fa-tag, fa-shopping-bag" value="{{ old('icon') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="variations[]" id="variation_{{ $variation }}" value="{{ $variation }}" {{ (old('variations') && in_array($variation, old('variations'))) ? 'checked' : '' }}>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        <li>Enter unique category name</li>
                        <li>Icon: FontAwesome class (e.g., fa-box)</li>
                        <li>Select brand if applicable</li>
                        <li>Choose variations for products</li>
                        <li>Keep category active for use</li>
                    </ul>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-exclamation-triangle mr-2"></i> Important</h6>
                    <p class="mb-0">Category name must be unique. Selected variations will be available when adding products.</p>
                </div>
            </div>
        </div>
    </div>
