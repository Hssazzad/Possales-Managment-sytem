...
<div class="d-flex justify-content-between align-items-center">
    <h1 style="font-size:1.3rem; font-weight:600; color:#343a40;">
        <i class="fas fa-edit mr-2" style="color:#c0392b;"></i> Edit User
    </h1>
        ...
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label style="font-weight:600; font-size:0.875rem;">New Password</label>
                    ...
                    <div class="form-group">
                        <label style="font-weight:600; font-size:0.875rem;">Confirm New Password</label>
                            ...
                            @foreach($roles as $role)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $role->id }}" 
                                           id="role_{{ $role->id }}" {{ in_array($role->id, $userRoles) ? 'checked' : '' }}>
