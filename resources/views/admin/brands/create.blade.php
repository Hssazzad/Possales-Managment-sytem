...
@section('title', 'New Brand | PosSales')

@section('content_header')
<div class="d-flex justify-content-between align-items-center">
    <h1 style="font-size:1.3rem; font-weight:600; color:#343a40;">
        <i class="fas fa-copyright mr-2" style="color:#17a2b8;"></i> New Brand
    </h1>
    <div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('brands.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter brand name" required value="{{ old('name') }}">
                                @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter brand description">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        <li>Enter unique brand name</li>
                        <li>Slug auto-generates if left blank</li>
                        <li>Upload brand logo (optional)</li>
                        <li>Keep brand active for use in products</li>
                    </ul>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-exclamation-triangle mr-2"></i> Important</h6>
                    <p class="mb-0">Brand name must be unique. Once created, you can use this brand when adding new products.</p>
                </div>
            </div>
        </div>
    </div>
