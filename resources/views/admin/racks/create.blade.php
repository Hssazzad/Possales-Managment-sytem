...
@section('title', 'New Rack | PosSales')

@section('content_header')
<div class="d-flex justify-content-between align-items-center">
    <h1 style="font-size:1.3rem; font-weight:600; color:#343a40;">
        <i class="fas fa-th-large mr-2" style="color:#fd7e14;"></i> New Rack
    </h1>
    <div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('racks.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter rack name" required value="{{ old('name') }}">
                                @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" placeholder="Enter rack location (e.g., Warehouse A, Section B)" value="{{ old('location') }}">
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter rack description">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-2"></i> Save Rack
                        </button>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        <li>Enter unique rack name</li>
                        <li>Code auto-generates if left blank</li>
                        <li>Specify location for easy finding</li>
                        <li>Keep rack active for use</li>
                    </ul>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-exclamation-triangle mr-2"></i> Important</h6>
                    <p class="mb-0">Rack code must be unique. Racks help organize products in your warehouse/store.</p>
                </div>
            </div>
        </div>
    </div>
